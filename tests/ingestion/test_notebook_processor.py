    ...
    return {
        "cells": [
            ...
            },
            {
                ...
                "outputs": [{"name": "stdout", "output_type": "stream", "text": ["Calculation done"]}]
            },
            {
                "cell_type": "markdown",
                "source": ["© IBM Corp., 2017-2025"]
            }
        ]
    }
...
def test_metadata_latex_detection(processor):
    ...
    nb_data = {
        "cells": [
            {"cell_type": "markdown", "source": ["Equation: $E=mc^2$"]}
        ]
    }
