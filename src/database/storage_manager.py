...
class QiskitVectorStore:
    ...
    def _initialize_db(self):
        ...
        if chroma_host and chroma_port:
            ...
            try:
                ...
                logger.warning(f"Could not connect to ChromaDB Server at {chroma_host}:{chroma_port} ({e}). Falling back to Local Mode.")
    ...
    def _format_metadata(self, raw_metadata: Dict[str, Any], chunk_id: str) -> Dict[str, Any]:
        """
        ...
        with open(jsonl_path, 'r', encoding='utf-8') as f:
            for line in tqdm(f, desc="Indexing Batches"):
                try:
                    ...
                    metadata = self._format_metadata(record.get('metadata', {}), chunk_id)
    ...
    def search(self, query: str, top_k: int = 20, filters: Dict[str, Any] = None) -> Dict[str, Any]:
        """
