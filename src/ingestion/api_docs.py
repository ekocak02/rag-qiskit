    ...
    def download_file(self, url: str) -> Optional[str]:
        ...
        try:
            ...
            if os.path.exists(save_path):
                logger.info(f"File already exists on disk (Skipping download): {filename}")
    ...
    if not os.path.exists("data/raw"):
        ...
        if not os.path.exists(Config.RAW_URL_FILE):
            with open(Config.RAW_URL_FILE, 'w') as f:
                f.write("https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.library.QuantumVolume") 
